...
int _tmain() {
	// ********************************************************
		...
		TCHAR ch1 = __T('AA');	// ch1= 65
		size_t s1 = sizeof(ch1);// s1= 1   //2 
		TCHAR ch2 = __T('Ф');	// ch2= -44 // 1060
		TCHAR ch3 = 'Ф';	// ch3= -44 // 65492
...
#include "WithRelease.h"
		...
		stop
			...
			int temp1 = 11, temp2 = 12, temp3 = 13;
		int* const pE = &temp1;
		int a = *pE;
		//pE = &temp2;
		*pE = 13;
